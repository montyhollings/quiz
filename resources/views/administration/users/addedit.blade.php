                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 ">
                                    <div class="form-group">
                                        <label for="role" class="text-md-right">{{ __('Role') }} <span class="required">*</span></label>
                                        <select name="role" id="role" class=" form-control @error('role') is-invalid @enderror">
                                            @foreach($roles as $role)
                                                <option @if($type == "edit" && $role->id == $user->role) selected @endif value="{{$role->id}}">{{$role->description}}</option>
                                            @endforeach
                                        </select>
